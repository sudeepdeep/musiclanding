...
export const AppleMusicIcon = ({ h = "6", w = "6" }: any) => {
  return (
    <svg
      ...
      viewBox="0 0 24 24"
    >
      <path d="M23.997 6.124c0-.738-.065-1.47-.24-2.19-.317-1.31-1.062-2.31-2.18-3.043C21.003.517 20.373.285 19.7.164c-.517-.093-1.038-.135-1.564-.15H5.986c-.525.015-1.046.057-1.563.15-.674.121-1.304.353-1.878.727-1.118.733-1.863 1.732-2.18 3.043-.175.72-.24 1.452-.24 2.19v11.754c0 .738.065 1.47.24 2.189.317 1.31 1.062 2.31 2.18 3.044.574.374 1.204.606 1.878.726.517.094 1.038.136 1.563.151h12.028c.526-.015 1.047-.057 1.564-.151.673-.12 1.303-.352 1.577-.726 1.118-.734 1.863-1.734 2.18-3.044.175-.719.24-1.451.24-2.189V6.124z" />
    </svg>
  );
};
