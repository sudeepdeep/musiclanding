...
export const AmazonMusicIcon = ({ h = "6", w = "6" }: any) => {
  ...
  viewBox="0 0 48 48" 
  xmlns="http://www.w3.org/2000/svg" 
  className={`bi bi-apple-music ${h !== "" ? `h-${h}` : "h-6"} ${w !== "" ? `w-${w}` : "w-6"} cursor-pointer hover:text-[#FF9900] transition-colors duration-200`}
  fill="currentColor"
>
  <style>
    {`
  ...
  <g>
    <circle className="svg-stroke" cx="24" cy="24" r="21.5"></circle>
    <path className="svg-stroke" d="M32.2807,29.7009c1.112-.451,3.0916-1.0492,3.6872-.3272.6446.7814-.17,2.4769-.92,3.7942"></path>
    <path className="svg-stroke" d="M11.7984,30.2234c1.7586,1.3965,6.9532,3.5343,12.4876,3.5343a17.0029,17.0029,0,0,0,10.1671-3.0789"></path>
    <path className="svg-stroke" d="M20.4043,20.125v3.3a2,2,0,0,0,2,2h0a2,2,0,0,0,2-2v-3.3"></path>
    <line className="svg-stroke" x1="24.4043" y1="23.425" x2="24.4043" y2="25.425"></line>
    <path className="svg-stroke" d="M10.4,22.225a2,2,0,0,1,2-2h0a2,2,0,0,1,2,2v3.2"></path>
    <line className="svg-stroke" x1="10.4001" y1="20.225" x2="10.4001" y2="25.425"></line>
    <path className="svg-stroke" d="M14.4,22.225a2,2,0,0,1,2-2h0a2,2,0,0,1,2,2v3.2"></path>
    <circle className="svg-fill" cx="31.88" cy="17.675" r="0.7"></circle>
    <line className="svg-stroke" x1="31.88" y1="20.125" x2="31.88" y2="25.425"></line>
    <path className="svg-stroke" d="M26.5407,24.9733a2.249,2.249,0,0,0,1.6448.4472h.4487a1.3236,1.3236,0,0,0,1.3222-1.325h0a1.3236,1.3236,0,0,0-1.3222-1.325h-.8974a1.3235,1.3235,0,0,1-1.3221-1.325h0a1.3235,1.3235,0,0,1,1.3221-1.325h.4487a2.2494,2.2494,0,0,1,1.6449.4472"></path>
    <path className="svg-stroke" d="M37.6,24.4176a1.9991,1.9991,0,0,1-1.7366,1.0074h0a2,2,0,0,1-2-2v-1.3a2,2,0,0,1,2-2h0a1.9989,1.9989,0,0,1,1.7346,1.0039"></path>
  </g>
</svg>
);
};
