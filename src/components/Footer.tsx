  ...
  const socialLinks = [
    {
      ...
      url: "https://www.instagram.com/djotime/",
    },
    {
      name: "Facebook",
      icon: (
      ...
      url: "https://www.facebook.com/Djokyri",
    },
    {
      name: "TikTok",
      icon: (
      ...
      url: "https://www.tiktok.com/@djo_time?lang=en",
    },
    {
      name: "YouTube",
      icon: (
      ...
      url: "https://www.youtube.com/@djomusic887",
    },
    // {
    //   name: "Spotify",
    //   icon: (
  ...
  const footerLinks = [
    {
      ...
      links: [
        ...
        { name: "Mailing List", url: "#mail" },
        {
         ...
         {
          name: "DJO Updates",
          url: "https://drop.cobrand.com/d/Djo/updates",
        },
      ],
    },
    {
