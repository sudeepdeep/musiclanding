  ...
  const newsItems = [
    {
      ...
      description:
        "DJO dropped a surprise deluxe edition of his third album with 12 additional tracks, released independently under AWAL.",
    ...
    },
    {
      ...
      description:
        "DJO began his Another Bite tour with a sold-out performance at College Street Music Hall, featuring former bandmates Post Animal as the opening act.",
    ...
    },
    {
      ...
      description:
        "DJO will support Lorde at Bristol's Forwards Presents event on August 28, 2026, performing alongside artists like Audrey Hobert and Rose Gray.",
      ...
      <div className="relative z-40 max-w-6xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-400 text-xl md:text-2xl">
            ...
            <img
              className="md:w-20 w-13 md:h-8 h-5 inline-block"
